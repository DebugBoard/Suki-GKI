...
>
> 最近更新：1.一加8ELITE处理器可使用6.6内核(未测试)、2.修复这些GKI版本编译报错——[5.10.(66、81、101)、5.15.(74、94、104)]、3.Android 15 6.6 现在使用 [NullDebris/android_kernel_nothing_sm7635](https://github.com/NullDebris/android_kernel_nothing_sm7635) 内核源码(为Nothing Phone优化)
### 下载
